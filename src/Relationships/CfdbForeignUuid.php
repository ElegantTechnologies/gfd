...
namespace SchoolTwistWip\Cfd\Cfdb\Uuid;



/* You can inherit from this as long as future min, max values are more constrained than this one */



Class CfdbForeignUuid extends \SchoolTwist\Cfd\Core\CfdBase implements  \SchoolTwistWip\Cfd\Cfdb\Core\CfdbLeaf, \SchoolTwistWip\Cfd\Cfdb\Core\ForeignKey_Interface
{
...
//            'canBeNull' => true,
    ...
    {
        return \SchoolTwistWip\Cfd\Relationships\Uuid::UuidString_Validates($candidateValue);
    }
